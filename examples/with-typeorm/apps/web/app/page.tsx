...
const LINKS = [
  {
    title: "Docs",
    href: "https://nrz.build/repo/docs",
    description: "Find in-depth information about Nrz features and API.",
  },
  {
    title: "Learn",
    href: "https://nrz.build/repo/docs/handbook",
    description: "Learn more about monorepos with our handbook.",
  },
  {
    title: "Templates",
    href: "https://nrz.build/repo/docs/getting-started/from-example",
    description: "Choose from over 15 examples and deploy with a single click.",
  },
  {
    title: "Deploy",
    href: "https://khulnasoft.com/new",
    description:
  ...
  return (
    <main className={styles.main}>
      <div className={styles.description}>
        ...
        <div>
          <a
            href="https://khulnasoft.com?utm_source=create-nrz&utm_medium=basic&utm_campaign=create-nrz"
          ...
          >
            ...
            <Image
              alt="Khulnasoft Logo"
              className={styles.khulnasoftLogo}
              height={24}
              priority
              src="/khulnasoft.svg"
              width={100}
      ...
      <div className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.nrzWordmarkContainer}>
            <svg
              className={styles.nrzWordmark}
              viewBox="0 0 506 50"
              width={200}
              xmlns="http://www.w3.org/2000/svg"
            >
              <title>Nrz logo</title>
