...
describe("nrzIgnore()", () => {
  ...
  it("throws pretty error and allows build when can't find previous sha", () => {
    ...
    process.env.KHULNASOFT_GIT_PREVIOUS_SHA = "too-far-back";
  ...
  it("allows build when no comparison is returned", () => {
    process.env.KHULNASOFT = "1";
    process.env.KHULNASOFT_GIT_PREVIOUS_SHA = "";
    process.env.KHULNASOFT_GIT_COMMIT_REF = "my-branch";
  ...
  it("skips build for `previousDeploy` comparison with no changes", () => {
    process.env.KHULNASOFT = "1";
    process.env.KHULNASOFT_GIT_PREVIOUS_SHA = "last-deployed-sha";
    process.env.KHULNASOFT_GIT_COMMIT_REF = "my-branch";
    ...
    validateLogs(mockConsole.log, [
      [
        "≫  ",
        "Using Nrz to determine if this project is affected by the commit...\n",
      ],
  ...
  it("skips when commit message contains a skip string", () => {
    process.env.KHULNASOFT = "1";
    process.env.KHULNASOFT_GIT_COMMIT_MESSAGE = "[khulnasoft skip]";
    ...
    validateLogs(mockConsole.log, [
      ...
      ["≫  ", 'Inferred nrz version ^2 based on "tasks" in "nrz.json"'],
      ["≫  ", 'Using "build" as the task as it was unspecified'],
      ["≫  ", "Found commit message: [khulnasoft skip]"],
      [expect.stringContaining("⏭ Ignoring the change")],
    ]);
  ...
  it("deploys when commit message contains a deploy string", () => {
    process.env.KHULNASOFT = "1";
    process.env.KHULNASOFT_GIT_COMMIT_MESSAGE = "[khulnasoft deploy]";
    ...
    validateLogs(mockConsole.log, [
      ...
      ["≫  ", 'Inferred nrz version ^2 based on "tasks" in "nrz.json"'],
      ["≫  ", 'Using "build" as the task as it was unspecified'],
      ["≫  ", "Found commit message: [khulnasoft deploy]"],
      [expect.stringContaining("✓ Proceeding with deployment")],
    ]);
  ...
  it("runs full nrz-ignore check when commit message contains a conflicting string", () => {
    process.env.KHULNASOFT = "1";
    process.env.KHULNASOFT_GIT_COMMIT_MESSAGE = "[khulnasoft deploy] [khulnasoft skip]";
    process.env.KHULNASOFT_GIT_PREVIOUS_SHA = "last-deployed-sha";
    process.env.KHULNASOFT_GIT_COMMIT_REF = "my-branch";
