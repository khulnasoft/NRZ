...
describe("examples", () => {
  describe("isUrlOk", () => {
    it("returns true if url returns 200", async () => {
      ...
      const url = "https://github.com/khulnasoft/nrz/";
    ...
    it("returns false if url returns status != 200", async () => {
      ...
      const url = "https://not-github.com/khulnasoft/nrz/";
      const result = await isUrlOk(url);
  ...
  describe("getRepoInfo", () => {
    it.each([
      {
        repoUrl: "https://github.com/khulnasoft/nrz/",
      ...
      {
        repoUrl:
          "https://github.com/khulnasoft/nrz/tree/canary/examples/kitchen-sink",
        examplePath: undefined,
      ...
      {
        repoUrl: "https://github.com/khulnasoft/nrz/tree/tek/test-branch/",
