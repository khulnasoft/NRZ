...
const meta: Rule.RuleMetaData = {
  ...
  docs: {
    ...
    recommended: true,
    url: `https://github.com/khulnasoft/nrz/tree/main/packages/eslint-plugin-nrz/docs/rules/${RULES.noUndeclaredEnvVars}.md`,
  },
  schema: [
    {
      type: "object",
...
/**
 * Nrz does some nice framework detection based on the dependencies in the package.json.  This function ports that logic to this ESLint rule.
 *
