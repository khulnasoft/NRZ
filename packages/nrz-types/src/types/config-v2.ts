...
export interface BaseSchema {
  /** @defaultValue `https://nrz.build/schema.v2.json` */
  $schema?: string;
  /**
   ...
   * your project.
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#tasks
   *
   * @defaultValue `{}`
   */
...
export interface RootSchema extends BaseSchema {
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#globaldependencies
   *
   * @defaultValue `[]`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#globalenv
   *
   * @defaultValue `[]`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#globalpassthroughenv
   *
   * @defaultValue `null`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/core-concepts/remote-caching
   *
   * @defaultValue `{}`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#ui
   *
   * @defaultValue `"stream"`
   */
  ui?: UI;
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#cachedir
   *
  ...
  /**
   * Nrz runs a background process to pre-calculate some expensive operations. This standalone process (daemon) is a performance optimization, and not required for proper functioning of `nrz`.
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#daemon
   *
   * @defaultValue `false`
   */
  daemon?: boolean;
  ...
  /**
   * Nrz's Environment Modes allow you to control which environment variables are available to a task at runtime:
   *
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#envmode
   *
   * @defaultValue `"strict"`
   */
  envMode?: EnvMode;
...
export interface Pipeline {
   ...
   * completed first.")
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#dependson
   *
   * @defaultValue `[]`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#env
   *
   * @defaultValue `[]`
   */
   ...
   * e.g. `AWS_SECRET_KEY`.
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#passthroughenv
   *
   * @defaultValue `null`
   */
   ...
   *
   * Nrz captures task logs for all tasks. This enables us to cache tasks whose runs
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#outputs
   *
   * @defaultValue `[]`
   */
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#cache
   *
   * @defaultValue `true`
   */
  cache?: boolean;
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#inputs
   *
   * @defaultValue `[]`
   */
  inputs?: Array<string>;
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/run#--output-logs-option
   *
   * @defaultValue `"full"`
   */
   ...
   * cannot depend on it.
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#persistent
   *
   * @defaultValue `false`
   */
  persistent?: boolean;
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#interactive
   *
   * @defaultValue `false`
   */
  interactive?: boolean;
   ...
   *
   * Documentation: https://nrz.build/repo/docs/reference/configuration#interruptible
   *
   * @defaultValue `false`
   */
...
export interface RemoteCache {
   ...
   * `true`, Nrz will sign every uploaded artifact using the value of the environment
   * variable `NRZ_REMOTE_CACHE_SIGNATURE_KEY`. Nrz will reject any downloaded artifacts
  ...
  /**
   * Indicates if the remote cache is enabled. When `false`, Nrz will disable
   ...
   * Documentation: https://nrz.build/repo/docs/core-concepts/remote-caching#self-hosting
   *
   * @defaultValue `"https://khulnasoft.com/api"`
   */
  apiUrl?: string;
  /**
   ...
   * Documentation: https://nrz.build/repo/docs/core-concepts/remote-caching#self-hosting
   *
   * @defaultValue `"https://khulnasoft.com"`
   */
  loginUrl?: string;
  /**
