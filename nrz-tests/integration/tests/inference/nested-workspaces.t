...
Locate a repository with no nrz.json. We'll get the right root, but there's nothing to run
  ...
  $ grep --quiet "| Follow directions at https://nrz.build/repo/docs to create one" INNER_NO_NRZ
...
Locate a repository with no nrz.json. We'll get the right root and inference directory, but there's nothing to run
  ...
  $ grep --quiet "| Follow directions at https://nrz.build/repo/docs to create one" INNER_NO_NRZ_APPS
  ...
  $ grep --quiet "| Follow directions at https://nrz.build/repo/docs to create one" OUTER_NO_NRZ
  ...
  $ grep --quiet "| Follow directions at https://nrz.build/repo/docs to create one" OUTER_NO_NRZ_APPS
