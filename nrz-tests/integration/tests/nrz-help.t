...
Test help flag
  ...
  Commands:
    ...
    daemon      Runs the Nrz background daemon
    ...
    logout      Logout to your Khulnasoft account
  ...
  Run Arguments:
    ...
    -F, --filter <FILTER>
            Use the given selector to specify package(s) to act as entry points. The syntax mirrors pnpm's syntax, and additional documentation and examples can be found in nrz's documentation https://nrz.build/repo/docs/reference/command-line-reference/run#--filter
        --affected
...
Test help flag for link command
  $ ${NRZ} link -h
  Link your local directory to a Khulnasoft organization and enable remote caching
...
Test help flag for unlink command
  $ ${NRZ} unlink -h
  Unlink the current directory from your Khulnasoft organization and disable Remote Caching
