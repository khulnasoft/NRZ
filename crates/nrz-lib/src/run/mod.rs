...
use nrz_repository::package_graph::{PackageGraph, PackageName, PackageNode};
use nrz_scm::SCM;
use nrz_telemetry::events::generic::GenericEventBuilder;
use nrz_ui::{
...
type UIResult<T> = Result<Option<(T, JoinHandle<Result<(), nrz_ui::Error>>)>, Error>;
    ...
    pub async fn run(&self, ui_sender: Option<UISender>, is_watch: bool) -> Result<i32, Error> {
        ...
        if let Some(subscriber) = self.signal_handler.subscribe() {
            ...
            tokio::spawn(async move {
                ...
                let spinner = nrz_ui::start_spinner("...Finishing writing to cache...");
