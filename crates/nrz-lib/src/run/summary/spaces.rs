...
use nrz_cache::CacheHitMetadata;
use nrz_khulnasoft_api::SpaceRun;
use serde::Serialize;
...
// https://khulnasoft.com/guides/how-to-bypass-khulnasoft-body-size-limit-serverless-functions
    ...
    fn from(value: SpacesTaskInformation) -> Self {
        ...
        let cache = cache_status.map_or_else(
            ...
            |CacheHitMetadata { source, time_saved }| SpacesCacheStatus {
                status: nrz_api_client::spaces::CacheStatus::Hit,
                source: Some(match source {
                    nrz_cache::CacheSource::Local => nrz_api_client::spaces::CacheSource::Local,
                    nrz_cache::CacheSource::Remote => nrz_api_client::spaces::CacheSource::Remote,
                }),
                time_saved,
            },
        );
