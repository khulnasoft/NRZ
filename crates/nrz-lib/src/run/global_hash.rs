...
use nrz_env::{get_global_hashable_env_vars, DetailedMap, EnvironmentVariableMap};
...
static DEFAULT_ENV_VARS: [&str; 1] = ["KHULNASOFT_ANALYTICS_ID"];
...
mod tests {
    ...
    use nrz_lockfiles::Lockfile;
    use nrz_repository::{package_graph::PackageInfo, package_manager::PackageManager};
    use nrz_scm::SCM;
