...
use nrz_env::{BySource, DetailedMap, EnvironmentVariableMap};
use nrz_repository::package_graph::{PackageInfo, PackageName};
use nrz_scm::SCM;
...
pub fn get_external_deps_hash(
    transitive_dependencies: &Option<HashSet<nrz_lockfiles::Package>>,
) -> String {
