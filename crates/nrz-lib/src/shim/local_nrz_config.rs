...
use nrz_repository::{inference::RepoState, package_manager::PackageManager};
use tracing::debug;
...
#[cfg(test)]
mod test {
    use nrz_repository::{inference::RepoMode, package_json::PackageJson, package_manager::Error};
