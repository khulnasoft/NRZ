...
use nrz_errors::{Spanned, NRZ_SITE};
use nrz_graph_utils as graph;
use nrz_repository::package_graph::{PackageGraph, PackageName, PackageNode, ROOT_PKG_NAME};
...
mod test {
    ...
    impl Lockfile for MockLockfile {
        fn resolve_package(
            ...
            _name: &str,
            _version: &str,
        ) -> Result<Option<nrz_lockfiles::Package>, nrz_lockfiles::Error> {
            unreachable!()
        }
        ...
        fn all_dependencies(
            &self,
            _key: &str,
        ) -> Result<Option<HashMap<String, String>>, nrz_lockfiles::Error> {
            unreachable!()
        }
        ...
        fn subgraph(
            ...
            _packages: &[String],
        ) -> Result<Box<dyn Lockfile>, nrz_lockfiles::Error> {
            unreachable!()
        }

        fn encode(&self) -> Result<Vec<u8>, nrz_lockfiles::Error> {
            unreachable!()
        }
    ...
    impl PackageDiscovery for MockDiscovery {
        async fn discover_packages(
            &self,
        ) -> Result<nrz_repository::discovery::DiscoveryResponse, nrz_repository::discovery::Error>
        {
            Ok(nrz_repository::discovery::DiscoveryResponse {
