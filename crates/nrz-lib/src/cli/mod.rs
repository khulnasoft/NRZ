...
pub use error::Error;
use nrz_api_client::AnonAPIClient;
use nrz_repository::inference::{RepoMode, RepoState};
use nrz_telemetry::{
...
impl From<OutputLogsMode> for nrz_ui::tui::event::OutputLogs {
    fn from(value: OutputLogsMode) -> Self {
        match value {
            OutputLogsMode::Full => nrz_ui::tui::event::OutputLogs::Full,
            OutputLogsMode::None => nrz_ui::tui::event::OutputLogs::None,
            OutputLogsMode::HashOnly => nrz_ui::tui::event::OutputLogs::HashOnly,
            OutputLogsMode::NewOnly => nrz_ui::tui::event::OutputLogs::NewOnly,
            OutputLogsMode::ErrorsOnly => nrz_ui::tui::event::OutputLogs::ErrorsOnly,
        }
    }
}
    ...
    pub fn track(&self, tel: &GenericEventBuilder) {
        ...
        if let Some(remote_cache_timeout) = self.remote_cache_timeout {
            tel.track_arg_value(
                ...
                nrz_telemetry::events::EventType::NonSensitive,
            );
        }
...
pub enum Command {
    ...
    /// Runs the Nrz background daemon
    Daemon {
    ...
    Ls {
        ...
        /// nrz's documentation https://nrz.build/repo/docs/reference/command-line-reference/run#--filter
        #[clap(short = 'F', long, group = "scope-filter-group")]
        filter: Vec<String>,
    ...
    /// Link your local directory to a Khulnasoft organization and enable remote
    /// caching.
    Link {
        ...
        /// The scope, i.e. Khulnasoft team, to which you are linking
        #[clap(long)]
        scope: Option<String>,
    ...
    /// Login to your Khulnasoft account
    Login {
        #[clap(long = "sso-team")]
    ...
    /// Logout to your Khulnasoft account
    Logout {
...
pub struct RunArgs {
    ...
    // Pass a string to enable posting Run Summaries to Khulnasoft
    #[clap(long, hide = true)]
...
pub async fn run(
    ...
    match AnonAPIClient::new("https://telemetry.khulnasoft.com", 250, version) {
