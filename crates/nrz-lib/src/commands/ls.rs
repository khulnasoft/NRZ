//! A command for outputting info about packages and tasks in a nrz.

use miette::Diagnostic;
use nrz_repository::package_graph::{PackageName, PackageNode};
use nrz_telemetry::events::command::CommandEventBuilder;
use nrz_ui::{color, cprint, cprintln, ColorConfig, BOLD, BOLD_GREEN, GREY};
