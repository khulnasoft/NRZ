//! The Nrz daemon watches files and pre-computes data to speed up nrz's
...
pub(crate) mod proto {
    ...
    impl From<PackageManager> for nrz_repository::package_manager::PackageManager {
    ...
    impl From<nrz_repository::package_manager::PackageManager> for PackageManager {
        fn from(pm: nrz_repository::package_manager::PackageManager) -> Self {
            match pm {
                nrz_repository::package_manager::PackageManager::Npm => Self::Npm,
                nrz_repository::package_manager::PackageManager::Yarn => Self::Yarn,
                nrz_repository::package_manager::PackageManager::Berry => Self::Berry,
                nrz_repository::package_manager::PackageManager::Pnpm => Self::Pnpm,
                nrz_repository::package_manager::PackageManager::Pnpm6 => Self::Pnpm6,
                nrz_repository::package_manager::PackageManager::Pnpm9 => Self::Pnpm9,
                nrz_repository::package_manager::PackageManager::Bun => Self::Bun,
            }
        }
    }
}
...
mod test {
    ...
    fn test_repo_hash() {
        ...
        let (path, expected_hash) = ("/tmp/nrz", "6e0cfa616f75a61c");
