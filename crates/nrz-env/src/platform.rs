use nrz_ci::Vendor;
use nrz_ui::{ceprint, ceprintln, color, ColorConfig, BOLD, GREY, UNDERLINE, YELLOW};
...
impl PlatformEnv {
    ...
    pub fn output_header(is_strict: bool, color_config: ColorConfig) {
        ...
        let docs_message = color!(
            color_config,
            UNDERLINE,
            "https://nrz.build/repo/docs/platform-environment-variables"
        );
        ...
        match ci {
            "KHULNASOFT" => {
                ceprintln!(
                    color_config,
                    BOLD,
                    "Warning - the following environment variables are set on your Khulnasoft \
