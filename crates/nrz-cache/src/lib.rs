...
pub enum CacheError {
    ...
    ApiClientError(Box<nrz_api_client::Error>, #[backtrace] Backtrace),
    ...
    ConfigCacheError,
    #[error("Insufficient permissions to write to remote cache. Please verify that your role has write access for Remote Cache Artifact at https://khulnasoft.com/docs/accounts/team-members-and-roles/access-roles/team-level-roles?resource=Remote+Cache+Artifact")]
    ForbiddenRemoteCacheWrite,
}

impl From<nrz_api_client::Error> for CacheError {
    fn from(value: nrz_api_client::Error) -> Self {
