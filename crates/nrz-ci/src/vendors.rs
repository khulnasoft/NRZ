        ...
        .get_or_init(|| {
            [
                ...
                Vendor {
                    ...
                    constant: "KHULNASOFT",
                    env: VendorEnvs {
                        any: vec!["NOW_BUILDER", "KHULNASOFT"],
                        all: vec![],
                    },
                    eval_env: None,
                    sha_env_var: Some("KHULNASOFT_GIT_COMMIT_SHA"),
                    branch_env_var: Some("KHULNASOFT_GIT_COMMIT_REF"),
                    username_env_var: Some("KHULNASOFT_GIT_COMMIT_AUTHOR_LOGIN"),
                    behavior: None,
                },
                Vendor {
