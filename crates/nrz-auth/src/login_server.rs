...
fn get_token_and_redirect(payload: SsoPayload) -> Result<(Option<String>, Url), Error> {
    let location_stub = "https://khulnasoft.com/notifications/cli-login/nrz/";
...
mod tests {
    ...
    fn test_get_token_and_redirect() {
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://khulnasoft.com/notifications/cli-login/nrz/success").unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://khulnasoft.com/notifications/cli-login/nrz/failed?loginError=error"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse(
                    "https://khulnasoft.com/notifications/cli-login/nrz/incomplete?ssoEmail=email"
                )
                .unwrap()
            )
        );
        ...
        assert_eq!(
            ...
            (
                None,
                Url::parse("https://khulnasoft.com/notifications/cli-login/nrz/incomplete?ssoEmail=email&teamName=team")
                    .unwrap()
            )
        );
