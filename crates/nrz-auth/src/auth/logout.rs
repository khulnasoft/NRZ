use nrz_api_client::TokenClient;
use nrz_dirs::{config_dir, khulnasoft_config_dir};
use nrz_ui::{cprintln, GREY};
...
mod tests {
    ...
    impl Client for MockApiClient {
        async fn get_user(&self, _token: &str) -> nrz_api_client::Result<UserResponse> {
            unimplemented!("get_user")
        }
        async fn get_teams(&self, _token: &str) -> nrz_api_client::Result<TeamsResponse> {
        ...
        fn make_url(&self, _endpoint: &str) -> nrz_api_client::Result<Url> {
    ...
    impl TokenClient for MockApiClient {
        ...
        async fn get_metadata(
            &self,
            _token: &str,
        ) -> nrz_api_client::Result<ResponseTokenMetadata> {
