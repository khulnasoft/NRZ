...
description: Learn about Nrz's Support policy.
---
...
active Node.js version on your system, but [some packages in the Nrz ecosystem](/repo/docs/reference#packages)
...
Nrz's [examples](/repo/docs/getting-started/examples) are also expected to work with these Node.js versions.
...
Major versions of Nrz will be supported for two years from the release date of the next major version.
...
We highly encourage you to use the most current version of Nrz whenever possible.
