...
description: Design and build your Nrz.
---
...
By the time you've read through all of this section, you should have a good understanding of how to design and build a monorepo with Nrz.

<Callout type="info">
  Nrz can also be used to speed up single-package workspaces. Visit the
