...
description: Learn how to understand your repository structure using Nrz.
---

Nrz includes tools for understanding your repository structure, that can help you use and optimize your codebase.
