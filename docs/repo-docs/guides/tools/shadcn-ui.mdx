---
title: shadcn/ui
description: Learn how to use shadcn/ui in a Nrz.
---
...
To learn more about using shadcn/ui in Nrz, [visit the docs for shadcn/ui](https://ui.shadcn.com/docs/monorepo).
