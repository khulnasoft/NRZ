---
title: Prisma
description: Learn how to use Prisma in a Nrz.
---
...
[Their official guide](https://www.prisma.io/docs/guides/using-prisma-orm-with-nrz#1-create-your-monorepo-using-nrz) describes how to integrate Prisma into a Nrz, including:
