---
title: Storybook
description: Learn how to use Storybook in a Nrz.
---
...
[Storybook](https://storybook.js.org/) is a popular way to build UI components in an isolated environment. By putting Storybook into your Nrz, you can easily develop your design system right alongside your applications.

## Quickstart

If you'd rather use a template, this guide is walking through how to build [this Storybook/Nrz template](https://khulnasoft.com/templates/react/nrz-design-system) on Khulnasoft.
...
Last, integrate the new Storybook application into your Nrz:
