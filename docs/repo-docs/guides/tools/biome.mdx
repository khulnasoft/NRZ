---
title: Biome
description: Learn how to use Biome in your Nrz projects.
---
...
## Using Biome with Nrz

Biome is a rare exception to most tools that are used with Nrz because it is **so extraordinarily fast**. For this reason, we recommend using a [Root Task](/repo/docs/crafting-your-repository/configuring-tasks#registering-root-tasks) rather than creating separate scripts in each of your packages.
...
To create a [Root Task](/repo/docs/crafting-your-repository/configuring-tasks#registering-root-tasks), register the scripts to Nrz:
