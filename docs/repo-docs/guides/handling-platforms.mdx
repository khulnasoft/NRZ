...
description: Learn how to handle caching around operating systems, architectures, and other arbitrary conditions for Nrz tasks.
---

## Node.js versions

To account for Node.js versions, use [the engines key in package.json](https://docs.npmjs.com/cli/v10/configuring-npm/package-json#engines). Nrz will account for changes to this field and miss cache accordingly.
