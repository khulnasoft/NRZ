...
To get started with Next.js in a Nrz quickly, follow the [quickstart](/repo/docs/getting-started/installation) to create a repository with two Next.js applications:
