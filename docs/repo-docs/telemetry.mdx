---
title: Telemetry
description: Learn more about Nrz's anonymous telemetry.
---

Khulnasoft Inc. (Khulnasoft) may collect telemetry data about your use of Nrz as explained below.
Telemetry data allows us to monitor and improve Nrz and the Khulnasoft platform by
...
Telemetry allows us to accurately gauge Nrz feature usage, pain points, and customization across all users.
This data enables us to better tailor Nrz to the masses, ensuring its continued growth, relevance, and best-in-class developer experience.
...
Additionally, all possible events can be viewed by browsing the [events](https://github.com/khulnasoft/nrz/blob/main/crates/nrz-telemetry/src/events) file directly.
