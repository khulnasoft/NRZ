---
title: Nrz API reference
description: Learn about Nrz's APIs using the reference.
---

import { Card, Cards } from '#/components/card';

Nrz's API reference is broken up into the following sections:
...
<Cards>
    ...
    <Card
        ...
        description="Extend your Nrz with new apps and packages."
    />
    ...
    <Card
        ...
        description="Enable the fastest defaults for your Nrz."
    />
...
<Cards>
    <Card
        ...
        description="Get started with Nrz using an example."
    />
    ...
    <Card
        ...
        description="Type definitions for Nrz generators."
    />
