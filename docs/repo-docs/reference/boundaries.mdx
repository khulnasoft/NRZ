...
Boundaries ensure that Nrz features work correctly by checking for package manager Workspace violations.
...
<Callout title="Boundaries RFC">
  ...
  Boundaries RFC](https://github.com/khulnasoft/nrz/discussions/9435).
