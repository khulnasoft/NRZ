...
description: Learn about system variables used by Nrz.
---

import { Heading } from 'fumadocs-ui/components/heading';

By setting certain environment variables, you can change Nrz's behavior. This can be useful for creating specific configurations for different environments and machines.
  ...
  <tbody>
    ...
    <tr id="nrz_platform_env">
      ...
      <td>
        ...
        environment (Khulnasoft). <strong>NOTE</strong>: This variable is meant for
    ...
    <tr id="nrz_team">
      ...
      <td>
        ...
        <a
          href="https://khulnasoft.com/docs/monorepos/remote-caching#khulnasoft-remote-cache"
          rel="noreferrer noopener"
          target="_blank"
        >
          Khulnasoft Remote Cache
        </a>
...
Nrz will make the following environment variables available within your tasks while they are executing:
